...
public class FreeCategoryAdapter extends RecyclerView.Adapter<FreeCategoryAdapter.DashboardViewHolder> {

    private Context context;
    private ArrayList<FreeList> dashboardItemList;
    private OnUserClickListener onCategoryItemClick;

    public FreeCategoryAdapter(Context context, ArrayList<FreeList> dashboardItemList) {
    ...
    public void onBindViewHolder(@NonNull DashboardViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        FreeList dashboardItemModel = dashboardItemList.get(position);
