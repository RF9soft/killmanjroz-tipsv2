package com.kilimanjaroz.tips.adapter.viptips;
...
public class VipTipsAdapter extends RecyclerView.Adapter<VipTipsAdapter.DashboardViewHolder> {

    private Context context;
    private ArrayList<VIPTipsList> dashboardItemList;


    public VipTipsAdapter(Context context, ArrayList<VIPTipsList> dashboardItemList) {
    ...
    public void onBindViewHolder(@NonNull DashboardViewHolder holder, final int position) {
        VIPTipsList dashboardItemModel = dashboardItemList.get(position);
        ...
        holder.odds.setText(dashboardItemModel.getOddsValue());
